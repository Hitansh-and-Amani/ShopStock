...
import 'package:shopstock/registerC.dart';
        ...
        body: Center(
            child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(onPressed: (){navigateToLoginCustomer(context);}, child: Text('Sign In'), style:
                  ElevatedButton.styleFrom(primary: Colors.blue)),
                  SizedBox(height: 50),
                  ElevatedButton(onPressed: (){navigateToRegisterCustomer(context);}, child: Text('Sign Up'), style:
                  ElevatedButton.styleFrom(primary: Colors.blue),)
                ])));
  }
}